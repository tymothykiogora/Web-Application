var submission = function() {
   ...
   if (year < 0) {
    ...
    if(male.checked && year > 0 && month > 0 && month < 12 && day > 0 && day < 31) {
        ...
        console.log ("Hey! " + " you were born on a " + daysOfTheWeek[results]  +  "and your Akan name is " + maleNames[results]);
    }
     else if(female.checked && year > 0 && month > 0 && month < 12 && day > 0 && day < 32) {
      
      console.log  ("Hey! " + " you were born on a " + daysOfTheWeek[results] + " and your Akan name is " + femaleNames[results]);
  }
 ...
 document.getElementById ("populate").addEventListener ("click",submission() )